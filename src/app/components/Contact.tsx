        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-6">
              <a href={`https://wa.me/27${propertyDetails.contact.whatsapp.slice(1)}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
              ...
              <a href={`mailto:${propertyDetails.contact.email}`} className="flex items-center gap-4 group">
          ...
          <div className="lg:pl-16 lg:border-l lg:border-white/10">
            ...
            <div className="space-y-4 mb-12">
              <a href={propertyDetails.contact.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-white/5 hover:bg-white/10 transition-colors">
                <div className="flex items-center gap-4">
              ...
              <a href={propertyDetails.contact.facebook} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-white/5 hover:bg-white/10 transition-colors">
                <div className="flex items-center gap-4">
            ...
            <div className="border-t border-white/10 pt-8">
              ...
              <div className="flex gap-4">
                <a href="https://www.airbnb.com/rooms/1591430106686520580" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-white/5 hover:bg-white/10 text-sm transition-colors">Airbnb</a>
                <a href="https://www.booking.com/hotel/za/big-14-guesthouse-randburg-johannesburg.html" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-white/5 hover:bg-white/10 text-sm transition-colors">Booking.com</a>
              </div>
            </div>
          </div>
        </div>
